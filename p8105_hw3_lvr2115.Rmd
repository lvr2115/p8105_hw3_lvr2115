...
In both years, the highest average data value among all 5 response groups is highest for those who responded "Very Good". Additionally, for both years as well, the average data value is highest to lowest in this order: "good", "excellent", "fair" and "poor". The spread of the data value for those who responded "Fair" increased from 2006 to 2010. 
...
For both women and men, those who have more than a HS education have a lower average age than the other two education groups. The average age for the less than HS and HS/HS equivalent education groups are about the same for women, but for men, the average age seems to be decreasing as educational group increases from less than HS to more than HS.


Aggregating across minutes to create a total activity variable for each participant.  This plot comparse men to women and have separate panels for each education level.
...
In the less than HS group, both women's and men's total activity drops with age more significantly than in the more than HS and HS/HS equivalent groups. In the high school equivalent group, the total activity for men and women rises until around 45 years old and then starts to decline, except women's total activity increases again around age 60. Interestingly, in the more than HS group, women experience an increase in total activity around age 65 while men experience a steep decrease at the same age. 

This three-panel plot shows the 24-hour activity time courses for each education level and uses color to indicate sex. 
